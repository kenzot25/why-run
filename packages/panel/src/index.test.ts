...
describe("panel", () => {
  ...
  describe("openPanel", () => {
    ...
    it("should set panel position styles", () => {
      ...
      const panel = document.querySelector(".why-run-panel") as HTMLElement
  ...
  describe("initPanel", () => {
    it("should expose whyRun to window", () => {
      initPanel()
      expect((window as any).whyRun).toBeTruthy()
      expect(typeof (window as any).whyRun.open).toBe("function")
      expect(typeof (window as any).whyRun.close).toBe("function")
      expect(typeof (window as any).whyRun.toggle).toBe("function")
      expect((window as any).whyRun.store).toBe(store)
    })
